...
import {AbsoluteFill, useCurrentFrame, staticFile, Video, interpolate, registerRoot, Composition} from "remotion";
...
const MyVideo: React.FC<{factIndex?: number}> = ({factIndex = 0}) => {
